...
BOT_TOKEN = "8674532989:AAGxIy4ImC29w9mfYadNN_14QTy2DXVau28"
...
def load_settings():
    if not os.path.exists(SETTINGS_FILE):
        default = {
            ...
            "otp_group_url": "https://t.me/+errxIt_eAsczYzNl",
            "channel_url": "https://t.me/znsuwbe62hw",
            "support_username": "@Ashik2m",
            ...
            "force_join_channels": ["https://t.me/znsuwbe62hw"], # ফোর্স জয়েন চ্যানেলসমূহ
...
async def support_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/Ashik2m", style="primary")]
    ])
                    ...
                    if (num in active_numbers and 
                        ...
                        user_otp_keyboard = InlineKeyboardMarkup([
                            ...
                            [
                                ...
                                InlineKeyboardButton("✔️ NUMBER ↗", url="https://t.me/Ashik2m", style="primary")
                            ]
                        ])
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ Developer", url="https://t.me/Ashik2m", style="danger"),
                                InlineKeyboardButton("📢 CHANNEL", url=channel_url, style="primary")
                            ]
                        ])
